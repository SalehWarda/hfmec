...
class ServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Architectural_Design = Service::create(['name' => ['en'=>'Architectural Design','ar'=>'التصميم المعماري'],
            'image'=>'architectural-design.jpg','status'=>true,
        ...
        $Landscape_Architecture = Service::create(['name' =>['en'=> 'Landscape Architecture','ar'=>'هندسة المناظر الطبيعية'],'image'=>'landscape-architecture.jpg','status'=>true,
        ...
        $Interior_Design = Service::create(['name' => ['en'=>'Interior Design','ar' => 'تصميم داخلي'],'image'=>'interior-design.jpg','status'=>true,
        ...
        $Graphics_and_Visualization= Service::create(['name' => ['en'=>'Graphics and Visualization','ar'=>'الرسومات والتصور'],'image'=>'graphics-and-visualization.jpg','status'=>true,
