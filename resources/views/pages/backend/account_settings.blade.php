                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_ar" class="form-control"
                                           value="{{old('name',auth()->user()->getTranslation('name','ar'))}}">
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_en" class="form-control"
                                           value="{{old('name',auth()->user()->getTranslation('name','en'))}}">
            ...
            $("#user_image").fileinput({
                ...
                initialPreviewConfig: [
                        @if(auth()->user()->user_image != '')
                    {
                        ...
                        size: '1111',
                        width: "120px",
                        url: "{{route('admin.profile.removeImage',['user_id'=> auth()->user()->id, '_token'=>csrf_token()])}}",
                        key: {{auth()->user()->id}}
                    }
                    @endif
                ]
