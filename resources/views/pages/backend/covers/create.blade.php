...
@section('title')
    ...
    {{trans('dashboard.HFMEC')}} - {{trans('dashboard.AddCover')}}
...
@section('content')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="mb-0">{{trans('dashboard.AddCover')}}</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}"
                                                       class="default-color">{{trans('dashboard.Home')}}</a></li>
                        <li class="breadcrumb-item active">{{trans('dashboard.AddCover')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <form method="post" action="{{route('admin.covers.store')}}" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="row pt-4">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <label for="image">{{trans('dashboard.coverImage')}} :</label>
                                                    <br>
