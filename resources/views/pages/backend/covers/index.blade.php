...
@section('title')
    ...
    {{trans('dashboard.HFMEC')}} - {{trans('dashboard.Cover')}}
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="modal-title">
                                                    <div class="mb-30">
                                                        ...
                                                        <h6>{{trans('dashboard.Delete')}} {{$cover->title}}</h6>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="form" action="{{ route('admin.covers.delete') }}"
                                                    ...
                                                    <h6>{{trans('dashboard.AreSureOfTheDeletingProcess')}}: <span
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-danger">{{trans('dashboard.Delete')}}
