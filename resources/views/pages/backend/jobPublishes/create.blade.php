...
@section('title')
    ...
    {{trans('dashboard.HFMEC')}} - {{trans('dashboard.AddJobs')}}
...
@section('content')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{trans('dashboard.AddJobs')}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}"
                                                   class="default-color">{{trans('dashboard.Main')}}</a></li>
                    <li class="breadcrumb-item active">{{trans('dashboard.AddJobs')}}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('admin.jobs.store')}}" autocomplete="off" >
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="title_ar" class="form-control" value="{{old('title_ar')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="title_en" class="form-control" value="{{old('title_en')}}">
