            ...
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('admin.roles.store')}}" autocomplete="off">
                        ...
                        <br>  <br>
                        <label> <strong> {{trans('dashboard.allowhimtoreach')}} :</strong></label>
                        <br>
                        <div class="row">

                            @foreach(config('general.permissions') as $name => $value)
                                <div class="custom-control custom-checkbox col-sm-3">
                                    <input id="role{{$loop->iteration}}" type="checkbox" class="custom-control-input" name="permissions[]" value="{{$name}}">{{$value}}
