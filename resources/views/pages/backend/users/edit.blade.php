...
@section('title')
    ...
    {{trans('dashboard.HFMEC')}} - {{trans('dashboard.EditUser')}}
...
@section('content')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{trans('dashboard.EditUser')}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}"
                                                   class="default-color">{{trans('dashboard.Main')}}</a></li>
                    <li class="breadcrumb-item active">{{trans('dashboard.EditUser')}}</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_ar" class="form-control" value="{{old('name_ar',$user->getTranslation('name','ar'))}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_en" class="form-control" value="{{old('name_en',$user->getTranslation('name','en'))}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg mb-15" name="role_id">
                                        ...
                                        @foreach($roles as $role)
                                            <option value="{{$role->id}}" {{old('role_id',$user->role_id) == $role->id ? 'selected' : null}}>{{$role->name}}</option>
