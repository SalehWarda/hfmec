            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/1.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                        <img src="{{asset('assets/frontend/images/main-slider/1.jpg')}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption sfl sfb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><div class="border-title">HFMEC Industrial Solutions</div></div>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/2.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                        <img src="{{asset('assets/frontend/images/main-slider/2.jpg')}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption sfl sfb tp-resizeme"
                             ...
                             data-endelementdelay="0.3"
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><div class="subtitle-text">Welcome to HFMEC</div></div>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/3.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                        <img src="{{asset('assets/frontend/images/main-slider/3.jpg')}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption sfl sfb tp-resizeme"
                             ...
                             data-endelementdelay="0.3"
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"><div class="subtitle-text">We are HFMEC Industry</div></div>
            ...
            <div class="row clearfix">
                ...
                <div class="service-block-two col-md-4 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="services-details.html"><img src="{{asset('assets/frontend/images/resource/service-image-1.jpg')}}" alt=""></a></figure>
                        </div>
                ...
                <div class="service-block-two col-md-4 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="services-details.html"><img src="{{asset('assets/frontend/images/resource/service-image-2.jpg')}}" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                            <div class="outer-link">
                ...
                <div class="service-block-two col-md-4 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="services-details.html"><img src="{{asset('assets/frontend/images/resource/service-image-4.jpg')}}" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                            <div class="outer-link">
                ...
                <div class="service-block-two col-md-4 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="services-details.html"><img src="{{asset('assets/frontend/images/resource/service-image-6.jpg')}}" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                            <div class="outer-link">
                ...
                <div class="gallery-carousel">
                    ...
                    <div class="gallery-item">
                        <div class="inner-box">
                            ...
                            <div class="image-box"><img src="{{asset('assets/frontend/images/gallery/1.jpg')}}" alt=""></div>
                    ...
                    <div class="gallery-item">
                        <div class="inner-box">
                            ...
                            <div class="image-box"><img src="{{asset('assets/frontend/images/gallery/2.jpg')}}" alt=""></div>
                    ...
                    <div class="gallery-item">
                        <div class="inner-box">
                            ...
                            <div class="image-box"><img src="{{asset('assets/frontend/images/gallery/3.jpg')}}" alt=""></div>
                    ...
                    <div class="gallery-item">
                        <div class="inner-box">
                            ...
                            <div class="image-box"><img src="{{asset('assets/frontend/images/gallery/4.jpg')}}" alt=""></div>
                        ...
                        <div class="featured-gallery">
                            <div class="row clearfix">
                                ...
                                <div class="featured-image-box col-md-12 col-sm-12 col-xs-12">
                                    <figure class="image">
                                        <a class="lightbox-image" href="{{asset('assets/frontend/images/resource/featured-image-1.jpg')}}" title="Image Caption Here"><img src="images/resource/featured-image-1.jpg" alt="" /></a>
                                    </figure>
                                </div>
                                ...
                                <div class="featured-image-box col-md-6 col-sm-6 col-xs-12">
                                    <figure class="image">
                                        <a class="lightbox-image" href="{{asset('assets/frontend/images/resource/featured-image-2.jpg')}}" title="Image Caption Here"><img src="images/resource/featured-image-2.jpg" alt="" /></a>
                                    </figure>
                                </div>
                                ...
                                <div class="featured-image-box col-md-6 col-sm-6 col-xs-12">
                                    <figure class="image">
                                        <a class="lightbox-image" href="{{asset('assets/frontend/images/resource/featured-image-3.jpg')}}" title="Image Caption Here"><img src="images/resource/featured-image-3.jpg" alt="" /></a>
                                    </figure>
                                </div>
                            ...
                            <li class="accordion block wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                ...
                                <div class="acc-content current">
                                    <div class="content clearfix">
                                        <figure class="image"><img src="{{asset('assets/frontend/images/resource/featured-thumb-1.jpg')}}" alt=""></figure>
                        ...
                        <div class="single-item-carousel">
                            ...
                            <div class="testimonial-box">
                                ...
                                <div class="author-info">
                                    <figure class="image">
                                        <img src="{{asset('assets/frontend/images/resource/author-thumb-1.jpg')}}" alt="" />
                                    </figure>
