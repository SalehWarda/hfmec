...
@section('content')
    ...
    <!--Page Title-->
    <section class="page-title" style="background-image:url({{asset('assets/images/about/'.$introduction->image)}});">
        <div class="auto-container">
            <h1>{{trans('dashboard.Introduction')}}</h1>
        </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <ul class="bread-crumb clearfix">
                            ...
                            <li class="active">{{trans('dashboard.Introduction')}}</li>
                        </ul>
                    </div>
                ...
                <div class="column col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="content-column">
                        <div class="sec-title-one">
                            <h2>{{trans('dashboard.IntroductionaboutHFMEC')}}</h2>
                        </div>
                        <div class="text">{!! $introduction->description !!}</div>
