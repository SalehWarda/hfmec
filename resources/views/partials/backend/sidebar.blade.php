<div class="side-menu-fixed">
    <div class="scrollbar side-menu-bg">
        <ul class="nav navbar-nav side-menu" id="sidebarnav">
            <!-- menu item Dashboard-->
            <li>
                <a href="{{route('dashboard')}}"><i class="ti-home"></i><span class="right-nav-text">الرئيسية </span></a>
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                    <div class="pull-left"><i class="ti-palette"></i><span class="right-nav-text">الخدمات</span></div>
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                    <div class="pull-left"><i class="ti-calendar"></i><span class="right-nav-text">المشاريع</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                    <li> <a href="{{route('admin.projects')}}">المشاريع</a> </li>
                </ul>
            </li>

            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#about-menu">
                    <div class="pull-left"><i class="ti-menu-alt"></i><span class="right-nav-text">نبذة عنا</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="about-menu" class="collapse" data-parent="#sidebarnav">
                    <li> <a href="{{route('admin.about.introduction')}}">المقدمة</a> </li>
                    <li> <a href="{{route('admin.about.vv')}}">الرؤيا والقيم</a> </li>
                    <li> <a href="{{route('admin.about.expertise-summary')}}">ملخص الخبرة</a> </li>
                    <li> <a href="{{route('admin.teams')}}">فريق العمل</a> </li>
                    <li> <a href="{{route('admin.about.imsPolicy')}}">سياسة IMS</a> </li>
                    <li> <a href="{{route('admin.about.isoCertificates')}}">شهادات الأيزو</a> </li>
                </ul>
            </li>

            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#new-menu">
                    <div class="pull-left"><i class="ti-comments"></i><span class="right-nav-text">أخبار الشركة</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="new-menu" class="collapse" data-parent="#sidebarnav">
                    <li> <a href="{{route('admin.news')}}">أخبار المكتب</a> </li>
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#career-menu">
                    <div class="pull-left"><i class="ti-panel"></i><span class="right-nav-text">وظائف الشركة</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="career-menu" class="collapse" data-parent="#sidebarnav">
                    <li> <a href="{{route('admin.projects')}}">وظائف الشركة</a> </li>
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#contact-menu">
                    <div class="pull-left"><i class="ti-email"></i><span class="right-nav-text">البريد الوارد</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="contact-menu" class="collapse" data-parent="#sidebarnav">
                    <li> <a href="{{route('admin.projects')}}">البريد الوارد</a> </li>
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#contact-menu">
                    <div class="pull-left"><i class="ti-user"></i><span class="right-nav-text">المستخدمين</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="contact-menu" class="collapse" data-parent="#sidebarnav">
                    <li> <a href="{{route('admin.projects')}}">المستخدمين</a> </li>
            ...
            <!-- menu item chat-->
            <li>
                <a href="chat-page.html"><i class="ti-settings"></i><span class="right-nav-text">الإعدادات </span></a>
            </li>
            <!-- menu item mailbox-->
            <li>
